...
const seeds: Seed[] = [
  ...
  { slug: "cekmekoy-oto-cekici", label: "Çekmeköy", district: "Yakın İlçe", landmark: "Çekmeköy merkez ve Şile Yolu", roads: ["Şile Otoyolu", "Alemdağ Caddesi", "Madenler Kavşağı"], nearby: ["tasdelen-oto-cekici", "sancaktepe-oto-cekici", "akpinar-mahallesi-oto-cekici", "umraniye-oto-cekici"] },
  { slug: "tasdelen-oto-cekici", label: "Taşdelen", district: "Yakın İlçe", landmark: "Taşdelen merkezi, Turgut Özal Caddesi ve Şile Yolu bağlantısı", roads: ["Turgut Özal Caddesi", "Şile Otoyolu", "Alemdağ Caddesi"], nearby: ["cekmekoy-oto-cekici", "sancaktepe-oto-cekici", "akpinar-mahallesi-oto-cekici"] },
